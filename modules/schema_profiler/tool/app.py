...
app = FastAPI(title="Schema Profiler")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("schema_profiler", base_url=FLOW_BASE_URL)
...
def profile(
    ...
    result, error = profile_schema(csv_text, has_header=has_header)
    if error:
