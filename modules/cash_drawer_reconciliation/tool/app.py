...
from modules.cash_drawer_reconciliation.core.reconcile import reconcile_cash_drawer
...
app = FastAPI(title="Cash Drawer Reconciliation")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("cash_drawer_reconciliation", base_url=FLOW_BASE_URL)
...
def reconcile(
    ...
    payload, error = reconcile_cash_drawer(pairs, expected)
    if error:
