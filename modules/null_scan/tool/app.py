...
from modules.null_scan.core.scan import scan_nulls
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("null_scan", base_url=FLOW_BASE_URL)
...
def scan(
    ...
    result, error = scan_nulls(csv_text, has_header=has_header)
    if error:
