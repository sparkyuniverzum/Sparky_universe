...
from modules.formula_to_steps.core.generate import build_steps
...
app = FastAPI(title="Formula to Steps")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("formula_to_steps", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    payload, error = build_steps(formula=formula, values_text=values)
    if error:
