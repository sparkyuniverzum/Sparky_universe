...
from modules.ad_policy_guard.core.guard import guard_copy
...
app = FastAPI(title="Ad Policy Guard")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("ad_policy_guard", base_url=FLOW_BASE_URL)
...
def scan(
    ...
    result, error = guard_copy(copy, category=category)
    if error:
