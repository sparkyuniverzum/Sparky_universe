...
UNITS: Dict[str, Dict[str, str | Decimal]] = {
    "kg": {"label": "Kilogram", "factor": Decimal("1")},
    "g": {"label": "Gram", "factor": Decimal("0.001")},
    "lb": {"label": "Pound", "factor": Decimal("0.45359237")},
    "oz": {"label": "Ounce", "factor": Decimal("0.028349523125")},
}
