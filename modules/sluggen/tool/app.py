...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("sluggen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    remove_accents: bool = Form(False),
):
    result, error = generate_slug(
        text,
        delimiter=delimiter,
        lowercase=lowercase,
