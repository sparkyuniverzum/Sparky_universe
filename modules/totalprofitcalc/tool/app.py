...
from modules.totalprofitcalc.core.profit import calculate_total_profit
...
app = FastAPI(title="Total Profit Calculator")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("totalprofitcalc", base_url=FLOW_BASE_URL)
...
def calc_total_profit(
    ...
    result, error = calculate_total_profit(price, cost, quantity, decimals=decimals)
    if error:
