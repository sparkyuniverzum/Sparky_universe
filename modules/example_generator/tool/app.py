...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("example_generator", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    payload, error = build_examples(concept=concept, domain=domain, items=items)
    if error:
