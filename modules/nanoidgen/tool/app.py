...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("nanoidgen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    alphabet: str | None = Form(None),
):
    result, error = generate_nanoids(length, count, alphabet=alphabet)
    if error:
