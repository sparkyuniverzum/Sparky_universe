...
from modules.time_slot_generator.core.slots import generate_slots
from universe.ads import attach_ads_globals
from universe.flows import resolve_flow_links
from universe.settings import shared_templates_dir

app = FastAPI(title="Time Slot Generator")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("time_slot_generator", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    payload, error = generate_slots(start_time, end_time, interval_minutes)
    if error:
