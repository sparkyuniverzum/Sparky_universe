...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("outlier_scan", base_url=FLOW_BASE_URL)
...
def scan(
    ...
    result, error = scan_outliers(csv_text, has_header=has_header)
    if error:
