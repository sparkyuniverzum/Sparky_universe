...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("pingen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    result, error = generate_pins(length, count, unique=unique)
    if error:
