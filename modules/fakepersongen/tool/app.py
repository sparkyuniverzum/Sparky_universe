...
from modules.fakepersongen.core.generate import generate_people
from universe.ads import attach_ads_globals
from universe.flows import resolve_flow_links
from universe.settings import shared_templates_dir

app = FastAPI(title="Fake Person Generator")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("fakepersongen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    result, error = generate_people(count, seed=seed)
    if error:
