...
from modules.price_ladder_builder.core.ladder import build_ladder
...
app = FastAPI(title="Price Ladder Builder")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("price_ladder_builder", base_url=FLOW_BASE_URL)
...
def build(
    ...
    increment: str | None = Form(None),
):
    payload, error = build_ladder(
        min_price,
        max_price,
        steps=steps,
        increment=increment,
