...
from modules.adcopylint.core.lint import lint_ad_copy
...
app = FastAPI(title="Ad Copy Linter")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("adcopylint", base_url=FLOW_BASE_URL)
...
def lint(
    ...
    result, error = lint_ad_copy(kind, lines)
    if error:
