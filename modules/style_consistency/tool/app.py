...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("style_consistency", base_url=FLOW_BASE_URL)
...
def check(
    ...
    preferred_case: str | None = Form(None),
):
    result, error = style_check(
        headline=headline,
        body=body,
