...
from modules.change_maker.core.change import DEFAULT_DENOMS, make_change
...
app = FastAPI(title="Change Maker")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("change_maker", base_url=FLOW_BASE_URL)
...
def compute(
    ...
    result, error = make_change(total, paid, denominations, decimals=decimals)
    if error:
