...
from modules.palettegen.core.palette import generate_palette
...
app = FastAPI(title="Color Palette Generator")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("palettegen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    result, error = generate_palette(base, steps, mode=mode)
    if error:
