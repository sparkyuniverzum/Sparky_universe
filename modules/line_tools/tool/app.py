...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("line_tools", base_url=FLOW_BASE_URL)
...
def process(
    ...
    trim_lines: bool = Form(True),
    remove_empty: bool = Form(False),
    dedupe: bool = Form(False),
    sort_mode: str | None = Form("none"),
    reverse: bool = Form(False),
    case_sensitive: bool = Form(True),
):
    result, error = process_lines(
        text,
