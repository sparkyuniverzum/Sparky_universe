...
app = FastAPI(title="Money to Words")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("money_to_words", base_url=FLOW_BASE_URL)
...
def convert(
    ...
    major_label: str | None = Form(None),
    minor_label: str | None = Form(None),
):
    payload, error = money_to_words(
        amount,
        language=language,
