...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("ulidgen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    result, error = generate_ulids(count, uppercase=uppercase)
    if error:
