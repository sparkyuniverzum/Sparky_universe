...
from modules.text_redactor.core.redact import redact_text
...
app = FastAPI(title="Text Redactor")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("text_redactor", base_url=FLOW_BASE_URL)
...
def redact(
    ...
    redact_iban: bool = Form(True),
    redact_card: bool = Form(True),
