...
from modules.passwordgen.core.generate import generate_passwords
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("passwordgen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    exclude_similar: bool = Form(False),
):
    result, error = generate_passwords(
        length,
        count,
        use_lower=use_lower,
        use_upper=use_upper,
