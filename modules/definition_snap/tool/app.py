...
from modules.definition_snap.core.generate import extract_definitions
...
app = FastAPI(title="Definition Snap")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("definition_snap", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    payload, error = extract_definitions(text=text, limit=limit)
    if error:
