...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("randdategen", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    result, error = generate_dates(start_date, end_date, count, unique=unique, seed=seed)
    if error:
