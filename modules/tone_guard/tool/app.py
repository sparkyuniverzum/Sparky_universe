...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("tone_guard", base_url=FLOW_BASE_URL)
...
def scan(
    ...
    result, error = guard_tone(text, target=target)
    if error:
