...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("sigfig_round", base_url=FLOW_BASE_URL)
...
def round_value(
    ...
    sigfigs: str | None = Form(None),
):
    result, error = round_sigfigs(value, sigfigs)
    if error:
