...
from modules.subjectline_grader.core.score import score_subject
...
app = FastAPI(title="Subject Line Grader")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("subjectline_grader", base_url=FLOW_BASE_URL)
...
@app.post("/score")
def score(subject: str | None = Form(None)):
    result, error = score_subject(subject)
    if error:
