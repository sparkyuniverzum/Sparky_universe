...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("regex_tester", base_url=FLOW_BASE_URL)
...
def test(
    ...
    dotall: bool = Form(False),
):
    result, error = test_regex(
        text,
        pattern,
