...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("ratiosimplify", base_url=FLOW_BASE_URL)
...
def simplify(
    ...
    result, error = simplify_ratio(left, right, decimals=decimals)
    if error:
