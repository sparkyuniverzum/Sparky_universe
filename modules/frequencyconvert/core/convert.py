...
UNITS: Dict[str, Dict[str, str | Decimal]] = {
    "hz": {"label": "Hertz", "factor": Decimal("1")},
    "khz": {"label": "Kilohertz", "factor": Decimal("1000")},
    "mhz": {"label": "Megahertz", "factor": Decimal("1000000")},
    "ghz": {"label": "Gigahertz", "factor": Decimal("1000000000")},
}
