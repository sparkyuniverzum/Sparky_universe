...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("cta_score", base_url=FLOW_BASE_URL)
...
@app.post("/score")
def score(cta: str | None = Form(None)):
    result, error = score_cta(cta)
    if error:
