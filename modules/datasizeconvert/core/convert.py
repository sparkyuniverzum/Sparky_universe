...
KIB = Decimal("1024")
MIB = KIB * Decimal("1024")
GIB = MIB * Decimal("1024")
TIB = GIB * Decimal("1024")
PIB = TIB * Decimal("1024")

UNITS: Dict[str, Dict[str, str | Decimal]] = {
    "B": {"label": "Byte", "factor": B},
    "KB": {"label": "Kilobyte (KB)", "factor": KB},
    "MB": {"label": "Megabyte (MB)", "factor": MB},
    "GB": {"label": "Gigabyte (GB)", "factor": GB},
    "TB": {"label": "Terabyte (TB)", "factor": TB},
    "PB": {"label": "Petabyte (PB)", "factor": PB},
    "KiB": {"label": "Kibibyte (KiB)", "factor": KIB},
    "MiB": {"label": "Mebibyte (MiB)", "factor": MIB},
    "GiB": {"label": "Gibibyte (GiB)", "factor": GIB},
    "TiB": {"label": "Tebibyte (TiB)", "factor": TIB},
    "PiB": {"label": "Pebibyte (PiB)", "factor": PIB},
}
