...
from modules.serplint.core.lint import lint_serp
...
app = FastAPI(title="SERP Snippet Linter")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("serplint", base_url=FLOW_BASE_URL)
...
def lint(
    ...
    result, error = lint_serp(title, description)
    if error:
