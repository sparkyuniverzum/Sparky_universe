...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("prime_tool", base_url=FLOW_BASE_URL)
...
@app.post("/analyze")
def analyze(number: str | None = Form(None)):
    result, error = analyze_prime(number)
    if error:
