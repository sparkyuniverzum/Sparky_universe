...
from modules.gcd_lcm.core.compute import compute_gcd_lcm
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("gcd_lcm", base_url=FLOW_BASE_URL)
...
@app.post("/compute")
def compute(values: str | None = Form(None)):
    result, error = compute_gcd_lcm(values)
    if error:
