...
from modules.sku_generator.core.generate import generate_skus
...
app = FastAPI(title="SKU Generator")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("sku_generator", base_url=FLOW_BASE_URL)
...
def generate(
    ...
    count: int = Form(20),
    width: int = Form(5),
    suffix_length: int = Form(0),
    separator: str = Form("-"),
):
    payload, error = generate_skus(
        prefix=prefix,
        category=category,
        start=start,
        count=count,
