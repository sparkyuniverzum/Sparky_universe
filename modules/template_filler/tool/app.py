...
from modules.template_filler.core.fill import fill_template
...
app = FastAPI(title="Template Filler")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("template_filler", base_url=FLOW_BASE_URL)
...
def fill(
    ...
    result, error = fill_template(text, mapping, strict=strict)
    if error:
