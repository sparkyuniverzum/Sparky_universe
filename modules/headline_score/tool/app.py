...
app = FastAPI(title="Headline Score")
...
def index(request: Request):
    ...
    flow_links = resolve_flow_links("headline_score", base_url=FLOW_BASE_URL)
...
@app.post("/score")
def score(headline: str | None = Form(None)):
    result, error = score_headline(headline)
    if error:
